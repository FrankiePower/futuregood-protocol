 ...
 *      Only the issuer (YieldSplitter) can mint and burn tokens
 */
contract PrincipalToken is ERC20 {
     ...
     * @param _name Full name of the token (e.g., "FutureGood USDC Principal")
     * @param _symbol Token symbol (e.g., "FG-PT-USDC")
     */
