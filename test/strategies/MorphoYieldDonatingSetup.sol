...
import {MorphoYieldDonatingStrategy as Strategy, ERC20} from "../../src/strategies/MorphoYieldDonatingStrategy.sol";
...
contract MorphoYieldDonatingSetup is Test, IEvents {
    ...
    function setUp() public virtual {
        ...
        // Use Steakhouse USDC Morpho Vault (well-known Morpho Vault V2)
        morphoVault = 0xBEEF01735c132Ada46AA9aA4c54623cAA92A64CB;
        require(morphoVault != address(0), "MORPHO_VAULT not set");
