...
import {MorphoYieldDonatingSetup as Setup, ERC20, IStrategyInterface, ITokenizedStrategy} from "./MorphoYieldDonatingSetup.sol";

contract MorphoYieldDonatingOperationTest is Setup {
    ...
    function test_profitableReport(uint256 _amount) public {
        ...
        console2.log("Profit from Morpho:", profit);
        ...
        console2.log("Morpho strategy successfully donated yield to dragonRouter");
    }
